...
RUN_NAME = os.environ.get("RUN_NAME", "treinamento1_com_test_cabeca")  # pode alterar via env var
...
optimizer_ft = optim.SGD(model_ft.classifier.parameters(), lr=LEARNING_RATE, momentum=MOMENTUM)
